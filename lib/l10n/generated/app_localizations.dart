...
abstract class AppLocalizations {
  ...
  /// No description provided for @recentPosition.
  ///
  /// In en, this message translates to:
  /// **'{time} ago'**
  String recentPosition(String time);

  /// No description provided for @estimatedPosition.
  ///
  /// In en, this message translates to:
  /// **'Estimated'**
  String get estimatedPosition;
  ...
  /// No description provided for @liveVoyage.
  ///
  /// In en, this message translates to:
  /// **'Live Voyage'**
  String get liveVoyage;
